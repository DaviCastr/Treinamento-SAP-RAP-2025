...
define root view entity YI_VIAGEM_EXT_DFLC
  as select from ytviagem_dflc as Viagem

  //Agência
  association [0..1] to YI_CE_AGENCIA_DFLC as _Agencia on $projection.AgenciaID = _Agencia.AgencyId
  //Cliente
